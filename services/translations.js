export const translations = {
  fr: {
    ...
    badge_gold:      '🏅 Éloquence Or',
    badge_gold_sub:  'Performance exceptionnelle !',
    encourage_title: 'Continuez comme ça.',
    encourage_sub:   'Revenez demain pour faire mieux.',
    btn_listen:      'Écouter',
    btn_pause:       'Pause',
  ...
  en: {
    ...
    badge_gold:      '🏅 Gold Eloquence',
    badge_gold_sub:  'Exceptional performance!',
    encourage_title: 'Keep going.',
    encourage_sub:   'Come back tomorrow to do better.',
    btn_listen:      'Listen',
    btn_pause:       'Pause',
    btn_resume:      'Resume',
    btn_share:       'Share',
